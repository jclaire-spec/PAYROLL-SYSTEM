...
<div id="body">
	<h2 class="page-title">📤 Read Sent Message</h2>
	...
	<div class="message-view-card">
		...
		<div class="message-details">
			<div class="message-detail-row">
				<div class="message-detail-label">Receiver ID</div>
				<div class="message-detail-value">
					<strong><?php echo htmlspecialchars($row['staff_id']); ?></strong>
				</div>
			</div>

			<div class="message-detail-row">
				<div class="message-detail-label">To</div>
				<div class="message-detail-value">
			...
			<div class="message-detail-row">
				<div class="message-detail-label">Date Sent</div>
				<div class="message-detail-value">
					<?php echo date('F d, Y \a\t g:i A', strtotime($row['date_sent'])); ?>
				</div>
			</div>
		...
		<div class="message-body-section">
			...
			<div class="message-content">
				<?php echo nl2br(htmlspecialchars(stripslashes($row['msg_msg']))); ?>
			</div>
		</div>

		<div class="message-actions-bar">
			<a href="outbox.php" class="btn-back">← Back to Outbox</a>
			<a href="delete.php?so_id=<?php echo $so_id; ?>" class="btn-delete" onclick="return confirm('Are you sure you want to delete this message?')">🗑️ Delete Message</a>
		</div>
	</div>
	<?php } else { ?>
	...
	<div class="message-actions-bar">
		<a href="outbox.php" class="btn-back" style="width: 100%; text-align: center;">← Back to Outbox</a>
	</div>
	<?php } ?>
</div>
</div>
