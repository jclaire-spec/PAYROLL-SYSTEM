					...
					<tbody>
						...
						if (mysqli_num_rows($qry) > 0) {
							while ($row = mysqli_fetch_array($qry)) {
								...
								echo "<a href='up_staff.php?staff_id=" . $row['staff_id'] . "' class='action-btn btn-edit'>Edit</a>";
								echo "<a href='im.php?staff_id=" . $row['staff_id'] . "' class='action-btn btn-message'>Message</a>";
								echo "<a href='delete.php?staff_id=" . $row['staff_id'] . "' class='action-btn btn-delete' onclick='return confirm(\"Are you sure you want to delete this staff member?\")'>Delete</a>";
								echo "</td>";
								echo "</tr>";
							}
						} else {
